...
export const DATA = {
    ...
    description:
        "Founder of Numletive, wants to talk with you on a world issues. A engineer who turned into wonderer and entrepreneur.",
    summary:
    ...
    contact: {
        ...
        social: {
            Instagram: {
                name: "Instagram",
                url: "https://instagram.com/hbpans",
            ...
            LinkedIn: {
                name: "LinkedIn",
                url: "https://www.linkedin.com/in/hbpans/",
                icon: Icons.linkedin,
            ...
            Youtube: {
                name: "Youtube",
                url: "https://www.youtube.com/@hbpans",
                icon: Icons.youtube,
                navbar: true,
            },
            email: {
